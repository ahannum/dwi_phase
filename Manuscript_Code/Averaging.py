def average(original_matrix, original_bvals = [], original_bvecs = [], operation_type = 'Magnitude'):
    ...
    from   FT_Operators import fft2c, ifft2c                                                                                 # Import Fourier transform operators from CarDpy
    ...
    return [averaged_matrix, averaged_bvals, averaged_bvecs, background_phase_removed_matrix]
